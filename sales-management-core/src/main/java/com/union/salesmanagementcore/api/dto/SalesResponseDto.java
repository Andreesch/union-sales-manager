...
public class SalesResponseDto {
    ...
    public SalesResponseDto setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SalesResponseDto setDescription(String description) {
    ...
    public SalesResponseDto setValue(Double value) {
        this.value = value;
        return this;
    }
    ...
    public SalesResponseDto setCreatedAt(LocalDateTime createdAt) {
    ...
    public SalesResponseDto setSalesmanId(String salesmanId) {
